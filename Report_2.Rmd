...
1. If the three-factor model of attitude is adequate to explain the pattern of correlation observed in the data?
2. If the first model combined with the method factors is a better model than the original model?
3. How should the discriminant of the three factors in section 2 be evaluated?
...
In order to compare these two models, an ANOVA test was conducted as below. It is worth noting that despite of the difference in AIC and BIC among these two models, the negative result indicated that this comparison is not meaningful.
